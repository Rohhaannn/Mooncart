      ...
      <div className="mx-auto flex max-w-6xl flex-col items-start space-x-8 md:flex-row">
        <div className="w-full px-4 md:w-1/2 lg:px-0">
          ...
          <div className='flex flex-col gap-2 mt-5 mb-5'>
            ...
            <Caption> Email: rohan@gmail.com </Caption>
            <Caption> Call: 555-998-895 </Caption>
          </div>
        </div>
        ...
        <div className='container grid-cols-1 grid md:grid-cols-2 lg:grid-cols-3 space-x-6'>
          <div>
            ...
            <div className='flex flex-col space-y-4 text-[14px] font-medium text-gray-500'>
              ...
              <CustomLink> Company History </CustomLink>
              <CustomLink> Our Team </CustomLink>
              <CustomLink> Our Vision </CustomLink>
              <CustomLink> Press Release </CustomLink>
            </div>
          </div>

  ...
  return (
    <div>
      <section className='content flex justify-between lg:px-16 h-[50vh] lg:h-[90vh] relative z-20'>
              ...
              <div className="flex items-center justify-center gap-3 mt-5">
                {color.map((color, i) => (
                  <div key={i}
                    ...
                    className={`w-4 h-4 rounded-full cursor-pointer border-gray-300 ${setSelectedColor === color.value ? "selected: " : ""}`}
                    style={{backgroundColor : color.value}}
                  >
                    {/* colors are displayed here */}
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className=''>
          <img src={image} alt="h-[60vh] w-full object-contain" />
        </div>
        
        <div className= "lg:h-[88px] lg:absolute lg:top-0 lg:right-0 lg:w-2/3 lg:z-10"></div>
